...
void Vadam_riscv::traceInitThis__1(Vadam_riscv__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->declBit  (c+166,"clk",-1);
	vcdp->declBit  (c+167,"rst",-1);
	vcdp->declBit  (c+166,"adam_riscv clk",-1);
	vcdp->declBit  (c+167,"adam_riscv rst",-1);
	...
	vcdp->declBit  (c+124,"adam_riscv wb_mem2reg",-1);
	vcdp->declBit  (c+166,"adam_riscv u_stage_if clk",-1);
	vcdp->declBit  (c+167,"adam_riscv u_stage_if rst",-1);
	...
	vcdp->declBit  (c+166,"adam_riscv u_stage_if u_pc clk",-1);
	vcdp->declBit  (c+1,"adam_riscv u_stage_if u_pc br_ctrl",-1);
	vcdp->declBus  (c+2,"adam_riscv u_stage_if u_pc br_addr",-1,31,0);
	vcdp->declBit  (c+167,"adam_riscv u_stage_if u_pc rst",-1);
	vcdp->declBus  (c+71,"adam_riscv u_stage_if u_pc pc_o",-1,31,0);
	vcdp->declBit  (c+3,"adam_riscv u_stage_if u_pc pc_stall",-1);
	vcdp->declBus  (c+125,"adam_riscv u_stage_if u_pc pc_next",-1,31,0);
	vcdp->declBus  (c+168,"adam_riscv u_stage_if inst_memory IROM_SPACE",-1,31,0);
	...
	vcdp->declBit  (c+166,"adam_riscv u_reg_if_id clk",-1);
	vcdp->declBit  (c+167,"adam_riscv u_reg_if_id rst",-1);
	...
	vcdp->declBit  (c+166,"adam_riscv u_stage_id clk",-1);
	vcdp->declBit  (c+167,"adam_riscv u_stage_id rst",-1);
	...
	vcdp->declBit  (c+126,"adam_riscv u_stage_id br_addr_mode",-1);
	vcdp->declBit  (c+41,"adam_riscv u_stage_id rs2_r_select",-1);
	vcdp->declBus  (c+42,"adam_riscv u_stage_id w_select_o",-1,1,0);
	vcdp->declBit  (c+166,"adam_riscv u_stage_id u_regs clk",-1);
	vcdp->declBit  (c+167,"adam_riscv u_stage_id u_regs rst",-1);
	...
	{int i; for (i=0; i<32; i++) {
		vcdp->declBus  (c+127+i*1,"adam_riscv u_stage_id u_regs regs_file",(i+0),31,0);}}
	{int i; for (i=0; i<4; i++) {
		vcdp->declBus  (c+159+i*1,"adam_riscv u_stage_id u_regs matrix_file",(i+0),31,0);}}
	vcdp->declBit  (c+43,"adam_riscv u_stage_id u_regs wb_hazard_a",-1);
	vcdp->declBit  (c+44,"adam_riscv u_stage_id u_regs wb_hazard_b",-1);
	vcdp->declBit  (c+163,"adam_riscv u_stage_id u_regs wb_hazard_m",-1);
	{int i; for (i=0; i<4; i++) {
		vcdp->declBus  (c+45+i*1,"adam_riscv u_stage_id u_regs w_matrix",(i+0),31,0);}}
	vcdp->declBus  (c+164,"adam_riscv u_stage_id u_ctrl inst_op",-1,6,0);
	...
	vcdp->declBit  (c+126,"adam_riscv u_stage_id u_ctrl br_addr_mode",-1);
	...
	vcdp->declBit  (c+166,"adam_riscv u_reg_id_ex clk",-1);
	vcdp->declBit  (c+167,"adam_riscv u_reg_id_ex rst",-1);
	...
	vcdp->declBit  (c+166,"adam_riscv u_reg_ex_mem clk",-1);
	vcdp->declBit  (c+167,"adam_riscv u_reg_ex_mem rst",-1);
	...
	vcdp->declBit  (c+166,"adam_riscv u_stage_mem clk",-1);
	vcdp->declBit  (c+167,"adam_riscv u_stage_mem rst",-1);
	...
	vcdp->declBus  (c+168,"adam_riscv u_stage_mem u_data_memory DROM_SPACE",-1,31,0);
	vcdp->declBit  (c+166,"adam_riscv u_stage_mem u_data_memory clk",-1);
	vcdp->declBit  (c+167,"adam_riscv u_stage_mem u_data_memory rst",-1);
	...
	vcdp->declBus  (c+165,"adam_riscv u_stage_mem u_data_memory byte_sel",-1,1,0);
	...
	vcdp->declBit  (c+166,"adam_riscv u_reg_mem_wb clk",-1);
	vcdp->declBit  (c+167,"adam_riscv u_reg_mem_wb rst",-1);
	...
	vcdp->declBit  (c+124,"adam_riscv u_reg_mem_wb wb_mem2reg",-1);
	...
	vcdp->declBit  (c+124,"adam_riscv u_stage_wb wb_mem2reg",-1);
	...
	vcdp->declBus  (c+164,"adam_riscv u_hazard_detection id_inst_op",-1,6,0);
...
void Vadam_riscv::traceFullThis__1(Vadam_riscv__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->fullBit  (c+124,(vlTOPp->adam_riscv__DOT__wb_mem2reg));
	vcdp->fullBus  (c+125,(vlTOPp->adam_riscv__DOT__u_stage_if__DOT__u_pc__DOT__pc_next),32);
	vcdp->fullBit  (c+126,((0x67U != (0x7fU & vlTOPp->adam_riscv__DOT__id_inst))));
	vcdp->fullBus  (c+127,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[0]),32);
	vcdp->fullBus  (c+128,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[1]),32);
	vcdp->fullBus  (c+129,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[2]),32);
	vcdp->fullBus  (c+130,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[3]),32);
	vcdp->fullBus  (c+131,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[4]),32);
	vcdp->fullBus  (c+132,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[5]),32);
	vcdp->fullBus  (c+133,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[6]),32);
	vcdp->fullBus  (c+134,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[7]),32);
	vcdp->fullBus  (c+135,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[8]),32);
	vcdp->fullBus  (c+136,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[9]),32);
	vcdp->fullBus  (c+137,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[10]),32);
	vcdp->fullBus  (c+138,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[11]),32);
	vcdp->fullBus  (c+139,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[12]),32);
	vcdp->fullBus  (c+140,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[13]),32);
	vcdp->fullBus  (c+141,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[14]),32);
	vcdp->fullBus  (c+142,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[15]),32);
	vcdp->fullBus  (c+143,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[16]),32);
	vcdp->fullBus  (c+144,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[17]),32);
	vcdp->fullBus  (c+145,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[18]),32);
	vcdp->fullBus  (c+146,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[19]),32);
	vcdp->fullBus  (c+147,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[20]),32);
	vcdp->fullBus  (c+148,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[21]),32);
	vcdp->fullBus  (c+149,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[22]),32);
	vcdp->fullBus  (c+150,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[23]),32);
	vcdp->fullBus  (c+151,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[24]),32);
	vcdp->fullBus  (c+152,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[25]),32);
	vcdp->fullBus  (c+153,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[26]),32);
	vcdp->fullBus  (c+154,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[27]),32);
	vcdp->fullBus  (c+155,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[28]),32);
	vcdp->fullBus  (c+156,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[29]),32);
	vcdp->fullBus  (c+157,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[30]),32);
	vcdp->fullBus  (c+158,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__regs_file[31]),32);
	vcdp->fullBus  (c+159,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__matrix_file[0]),32);
	vcdp->fullBus  (c+160,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__matrix_file[1]),32);
	vcdp->fullBus  (c+161,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__matrix_file[2]),32);
	vcdp->fullBus  (c+162,(vlTOPp->adam_riscv__DOT__u_stage_id__DOT__u_regs__DOT__matrix_file[3]),32);
	vcdp->fullBit  (c+163,((1U & ((IData)(vlTOPp->adam_riscv__DOT__w_select) 
				      >> 1U))));
	vcdp->fullBus  (c+164,((0x7fU & vlTOPp->adam_riscv__DOT__id_inst)),7);
	vcdp->fullBus  (c+165,((3U & (IData)(vlTOPp->adam_riscv__DOT__me_func3_code))),2);
	vcdp->fullBit  (c+166,(vlTOPp->clk));
	vcdp->fullBit  (c+167,(vlTOPp->rst));
	vcdp->fullBus  (c+168,(0x400U),32);
    }
}
